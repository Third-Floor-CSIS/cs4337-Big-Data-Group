...
public class TestJwtService {
    ...
    public void Setup() {
        ...
        JwtRefreshTokenRepository mockJwtRefreshTokenRepository = Mockito.mock(JwtRefreshTokenRepository.class);
        jwtService = new JwtService(testSecretKey, testJwtExpiration, testJwtRefreshExpiration, mockJwtRefreshTokenRepository);
    }
    ...
    public void isTokenExpired_shouldReturnFalse_whenTokenIsValid() {
        ...
        boolean isTokenExpired = jwtService.hasTokenExpired(token);
